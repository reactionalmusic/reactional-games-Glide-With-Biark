    ...
    public static class Setup
    {
                ...
                foreach (var playlist in section.playlists)
                {
                    ...
                    if (track != null)
                    {
                        ...
                        if (bundle.path.Contains("StreamingAssets"))
                            ...
                            path = bundle.path;
                        track.trackID = AssetHelper.AddTrackFromPath(engine, System.IO.Path.Combine(path, track.trackHash));
                        if (track.trackID >= 0)
                        {
        ...
        public static async Task LoadTheme(string bundleName, string sectionName, string themeName)
        {
            ...
            if (bundle.path.Contains("StreamingAssets"))
                ...
                path = bundle.path;
            theme.trackID = AssetHelper.AddTrackFromPath(engine, System.IO.Path.Combine(path, theme.trackHash));
